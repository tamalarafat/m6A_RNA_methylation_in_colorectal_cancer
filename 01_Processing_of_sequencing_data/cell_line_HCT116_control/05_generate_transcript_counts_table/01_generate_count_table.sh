...
data_dir="/ds/storage/common/ytamal_work/Project_14052024_ONT_RNAseq/PAS98818_FLO_PRO004RA_SQK_RNA004_HCT_ctr/analysis_of_the_sample/analysis_output/basecalled_reads_sorted.bam"
...
time NanoCount -i "$data_dir" --extra_tx_info -o "$output_dir/hct_ctr.tsv" --verbose