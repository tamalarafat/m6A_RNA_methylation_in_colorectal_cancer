...
data_dir="/ds/storage/common/ytamal_work/Project_14052024_ONT_RNAseq/PAS98400_FLO_PRO004RA_SQK_RNA004_HCT_Ki/analysis_of_the_sample/Basecalled_aligned_data/basecalled_reads_resumed.bam"
...
time $ONTrna_dorado summary "$data_dir" > "$output_dir/HCT_ki_summary.tsv"
