...
# control group
temp_ki = temp_df[temp_df$diff_mod_rate < 0 & temp_df$DRACH == "YES", ]
...
temp_top = temp_ki[temp_ki$mers %in% temp_motif$Var1[1], ]
...
ggsave(filename = "03_Figure_4_ki_DRACH_top.png", plot = p, width = 12, height = 6, dpi = 300)

# 2nd
temp_top = temp_ki[temp_ki$mers %in% temp_motif$Var1[2], ]
...
ggsave(filename = "03_Figure_4_ki_DRACH_top2.png", plot = p, width = 12, height = 6, dpi = 300)


# 3rd
temp_top = temp_ki[temp_ki$mers %in% temp_motif$Var1[3], ]
...
ggsave(filename = "03_Figure_4_ki_DRACH_top3.png", plot = p, width = 12, height = 6, dpi = 300)


# 2nd
temp_top = temp_ki[temp_ki$mers %in% temp_motif$Var1[4], ]
...
ggsave(filename = "03_Figure_4_ki_DRACH_top4.png", plot = p, width = 12, height = 6, dpi = 300)
