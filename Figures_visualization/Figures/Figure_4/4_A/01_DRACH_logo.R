...
ggsave(filename = "01_Figure_4_control_DRACH.png", plot = p, width = 12, height = 6, dpi = 300)
...
ggsave(filename = "01_Figure_4_ki_motif.png", plot = p, width = 12, height = 6, dpi = 300)
