...
# DEGs
DEGs = read.table("~/Documents/Projects/Git_repositories/effect_of_METTL3_on_m6A_in_cancer/Analyses/Analysis_of_all_samples/01_whole_data_analysis/02_analysis_on_counts/analysis_output/06_characteristic_degs/DEG_up_in_ctr_group.csv")
...
ggsave(filename = "03_Figure_5_1.png", plot = p, width = 6, height = 6, dpi = 300)
...
ggsave(filename = "03_Figure_5_2.png", plot = p, width = 6, height = 6, dpi = 300)
...
ggsave(filename = "03_Figure_5_3.png", plot = p, width = 6, height = 6, dpi = 300)
