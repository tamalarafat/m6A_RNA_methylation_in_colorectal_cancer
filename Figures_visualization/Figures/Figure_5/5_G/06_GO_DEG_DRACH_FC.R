...
# Ki_deg
ki_deg = read.table("~/Documents/Projects/Git_repositories/effect_of_METTL3_on_m6A_in_cancer/Analyses/Analysis_of_all_samples/01_whole_data_analysis/02_analysis_on_counts/analysis_output/06_characteristic_degs_lowFC/DEG_up_in_ki_group.csv")
...
ggsave(filename = "08_Figure_5_FC.png", plot = p, width = 14, height = 14, dpi = 300)
...
p2 <- emapplot(GeneSet_ORA_BP, color = "qvalue", cex_label_category = 2.5, cex_category = 2)  + theme_bw() + 
  theme(panel.grid.major = element_blank(),
        ...
        legend.key.size = unit(3,"line"),
        legend.position = "none")
ggsave(filename = "08_Figure_5_FC_network.png", plot = p2, width = 22, height = 22, dpi = 300)
