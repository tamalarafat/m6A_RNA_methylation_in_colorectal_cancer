...
# DEGs
res = loadRData("~/Documents/Projects/Git_repositories/effect_of_METTL3_on_m6A_in_cancer/Analyses/Analysis_of_all_samples/01_whole_data_analysis/02_analysis_on_counts/analysis_output/07_simulated_analysis_results/02_deg_files/DEG_DESeq_rep_1_mpi_ctr_rep_1_mpi_ki_rep_2_mpi_ctr_rep_2_mpi_ki_rep_3_mpi_ctr_rep_3_mpi_ki.RData")
...
ggsave(filename = "04_Figure_6.png", plot = p, width = 8, height = 8, dpi = 300)
