...
crtl_degs = read.table("~/Documents/Projects/Git_repositories/effect_of_METTL3_on_m6A_in_cancer/Analyses/Analysis_of_all_samples/01_whole_data_analysis/02_analysis_on_counts/analysis_output/06_characteristic_degs/DEG_up_in_ctr_group.csv")
...
ctrl_df = data.frame("up" = c(3591, 13), "nonUp" = c(8109, 16), row.names = c("DRACH", "DEGs")) # 20 out of 23

fisher.test(ctrl_df) # p-value = 0.1085
...
# load the degs identified in the control group
ki_degs = read.table("~/Documents/Projects/Git_repositories/effect_of_METTL3_on_m6A_in_cancer/Analyses/Analysis_of_all_samples/01_whole_data_analysis/02_analysis_on_counts/analysis_output/06_characteristic_degs/DEG_up_in_ki_group.csv")
